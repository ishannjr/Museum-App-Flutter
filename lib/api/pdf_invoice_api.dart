...
import 'package:email_password_login/utils.dart';
...
class PdfInvoiceApi {
  static Future<File> generate(Invoice invoice) async {
    ...
    return PdfApi.saveDocument(name: 'Ticket.pdf', pdf: pdf);
  }
  ...
  static Widget buildFooter(Invoice invoice) => Column(
        ...
        children: [
          ...
          SizedBox(height: 1 * PdfPageFormat.mm),
          buildSimpleText(title: 'GPay', value: invoice.supplier.paymentInfo),
        ],
      );
